  ...
  isBalanced_231025_hard(root) {
    ...
    while (stack.length) {
      ...
      if (node.left && !seen.has(node.left)) {
        ...
        const leftH = seen.get(node.left);
        const rightH = seen.get(node.right);
  ...
  isBalanced_010925_good(root) {
    ...
    while (stack.length) {
      ...
      if (node.left && !seen.has(node.left)) {
        ...
        let lHeight = seen.get(node.left);
        let rHeight = seen.get(node.right);
