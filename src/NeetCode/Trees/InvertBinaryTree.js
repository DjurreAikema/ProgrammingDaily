...
class Solutions {
  ...
  invertTree_250725_easy(root) {
    const queue = [root];

    while (queue.length) {
      // pop() for DFS, shift() for BFS
      let node = queue.pop();
