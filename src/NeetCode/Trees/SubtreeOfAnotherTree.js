...
class Solutions {
  ...
  // All solutions
  isSubtree_281125_easy(root, subRoot) {
    if (!subRoot) return true;
    if (!root) return false;
  ...
  isSubtree_280825_hard(root, subRoot) {
    if (!subRoot) return true;
    if (!root) return false;
  ...
  isSubtree_240725_good(root, subRoot) {
    if (!subRoot) return true;
    if (!root) return false;
